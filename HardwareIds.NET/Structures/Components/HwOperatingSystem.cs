namespace HardwareIds.NET.Structures.Components
{
    ...
    public class HwOperatingSystem
    {
        ...
        /// <summary>
        /// Gets or sets the machine GUID generated by Windows at installation.
        /// </summary>
        [JsonPropertyName("machine_guid")]
        public string? MachineGuid { get; set; }

        /// <summary>
        /// Gets or sets the SQM (telemetry) machine identifier.
        /// </summary>
        [JsonPropertyName("sqm_machine_id")]
        public string? SqmMachineId { get; set; }

        /// <summary>
        /// Gets or sets the hardware profile GUID.
        /// </summary>
        [JsonPropertyName("hardware_profile_guid")]
        public string? HardwareProfileGuid { get; set; }

        /// <summary>
        /// Gets or sets the precise installation time.
        /// </summary>
        [JsonPropertyName("install_time")]
        public DateTime? InstallTime { get; set; }

        /// <summary>
        /// Gets or sets the security identifier of the machine.
        /// </summary>
        [JsonPropertyName("machine_sid")]
